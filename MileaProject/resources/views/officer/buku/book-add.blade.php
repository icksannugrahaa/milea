...
<div class="container">
    ...
    <form action="{{route('book.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <textarea name="sinopsis" id="sinopsis" class="form-control @error('sinopsis') is-invalid @enderror"
                    rows="2" value="{{ old('penerbit') }}" required>{{ old('penerbit') }}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="tahunterbit" type="text" class="form-control @error('tahunterbit') is-invalid @enderror"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="hal" type="text" class="form-control @error('hal') is-invalid @enderror" name="hal"
